import { aws_lambda as lambda, aws_events as events, aws_events_targets as targets, aws_iam as iam, Duration, } from 'aws-cdk-lib';
/**
 * Creates Lambda function and EventBridge rule for nightly instance reboot
 */
export function createNightlyReboot(scope, id, props) {
    const { instanceId, schedule = '0 8 * * ? *', description = 'Daily reboot of Mail-in-a-Box instance at 03:00 ET (08:00 UTC)', region, account, } = props;
    ...
    rebootLambdaRole.addToPolicy(new iam.PolicyStatement({
...
//# sourceMappingURL=nightly-reboot.js.map