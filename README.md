...
This repository also contains an Nx monorepo (CDK stacks, CMS, ops tools). Runbooks, ADRs, and engineering guides are indexed in [docs/README.md](docs/README.md). For **how git history is published** and what stays out of the public tree, see [docs/COMMIT-HISTORY.md](docs/COMMIT-HISTORY.md).
