...
Options:
  --app-path PATH          App path used for domain/stack resolution (default: apps/clients/cdk-client-example/core)
...
async function main(): Promise<void> {
  ...
  const appPath = cli.appPath || process.env.APP_PATH || 'apps/clients/cdk-client-example/core';
  const region =
    cli.region ||
