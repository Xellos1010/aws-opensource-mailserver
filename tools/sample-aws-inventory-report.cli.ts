#!/usr/bin/env tsx
/** Concise inventory: CFN stacks → cost/last-use; EC2/λ/EBS outside any stack. Default profile your-aws-profile. */
import {
...
function parseArgs(a: string[]): Opts {
  let profile = 'your-aws-profile';
  let regions: 'all' | string[] = 'all';
  let activityDays = 14;
  let out = 'reports/aws-inventory-sample.md';
