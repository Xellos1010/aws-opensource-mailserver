...
Options:
  ...
  --profile PROFILE        AWS profile for credentials (e.g., "your-aws-profile")
...
Examples:
  # Bootstrap example.com instance
  DOMAIN=example.com pnpm nx run ops-runner:instance:bootstrap

  # Dry run for different domain
  DOMAIN=example.org pnpm nx run ops-runner:instance:bootstrap -- --dry-run

  # Explicit stack name
  STACK=my-alt-instance-stack pnpm nx run ops-runner:instance:bootstrap

  # With restore prefix
  DOMAIN=example.com pnpm nx run ops-runner:instance:bootstrap -- --restore-prefix i-1234567890abcdef0
`);
}
