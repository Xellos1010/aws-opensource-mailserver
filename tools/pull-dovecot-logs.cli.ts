...
Examples:
  pnpm nx run cdk-client-example-instance:admin:logs:dovecot
  FILTER_ERRORS=1 pnpm nx run cdk-client-example-instance:admin:logs:dovecot
  LOG_LINES=1000 pnpm nx run cdk-client-example-instance:admin:logs:dovecot
`);
        process.exit(0);
    }
  }
