...
async function cleanupMiab(options: CleanupOptions): Promise<void> {
  ...
  const appPath = options.appPath || 'apps/clients/cdk-client-example/instance';
  ...
  try {
    ...
    console.log(`      pnpm nx run cdk-client-example-instance:admin:bootstrap-miab-ec2-instance\n`);
    console.log('   2. Verify installation:\n');
    console.log(`      pnpm nx run cdk-client-example-instance:admin:miab:audit\n`);
