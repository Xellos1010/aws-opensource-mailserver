 ...
 * 
 * Usage:
 *   APP_PATH=apps/clients/cdk-client-example/instance DOMAIN=example.com pnpm exec tsx tools/set-ses-dns-miab.cli.ts
 */
...
async function setSesDnsRecords() {
  ...
  try {
    ...
    if (failed === 0) {
      ...
      console.log('   3. Verify with: pnpm nx run cdk-client-example-instance:admin:ses:status\n');
    } else {
