...
/**
 * Quick restore script for example.net
...
async function main(): Promise<void> {
  ...
  if (!DOMAIN) {
    ...
    console.error('Usage: DOMAIN=example.net pnpm nx run cdk-client-example-instance:admin:restore:example');
    process.exit(1);
  }
  ...
  console.log('🔄 Sample net Restore');
