    ...
    return new Promise((resolve, reject) => {
      ...
      ssh.on('close', (code) => {
        ...
        if (code === 0) {
          ...
          console.log('\n💡 Next steps:');
          console.log(`   1. Verify certificates: pnpm nx run cdk-client-example-instance:admin:bootstrap:confirm`);
          ...
          console.error(`   3. Verify SSH key is correct: pnpm nx run cdk-client-example-instance:admin:ssh:test`);
          ...
          console.log(`\n💡 Verify SSL status: pnpm nx run cdk-client-example-instance:admin:ssl:status\n`);
