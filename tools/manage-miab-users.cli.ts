...
Examples:
  ...
  # Add admin user
  pnpm exec tsx tools/manage-miab-users.cli.ts --action add --email admin@example.com --password <password> --admin

  # Remove user
  pnpm exec tsx tools/manage-miab-users.cli.ts --action remove --email user@example.com
