...
/**
 * Force cleanup and deploy script for sample-net core stack
 * 
 * This script:
...
async function main(): Promise<void> {
  ...
  runCommand(
    `pnpm tsx tools/cleanup-sample-net-core.cli.ts`,
  ...
  const deployCmd = `AWS_PROFILE=${PROFILE} AWS_REGION=${REGION} FEATURE_CDK_MAILSERVER_DEMO_ENABLED=1 DOMAIN=example.net pnpm nx run cdk-client-example-core:deploy`;
