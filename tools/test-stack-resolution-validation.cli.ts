...
const testCases: TestCase[] = [
  ...
  },
  {
    ...
    config: { appPath: 'apps/clients/cdk-client-example/instance' },
    shouldFail: false,
  },
  {
    name: 'Should succeed with stackName only',
    config: { stackName: 'example-com-mailserver-instance' },
    shouldFail: false,
  },
  {
    name: 'Should succeed with domain and appPath',
    config: { domain: 'example.com', appPath: 'apps/clients/cdk-client-example/instance' },
    shouldFail: false,
  },
];
