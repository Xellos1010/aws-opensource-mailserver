...
# Deploy script for askdaokapra.com with existing S3 buckets
# This script handles the existing S3 buckets for askdaokapra

set -e

# Configuration
DOMAIN_NAME="askdaokapra.com"
STACK_NAME="askdaokapra-com-mailserver"
EXISTING_BACKUP_BUCKET="askdaokapra-opensource-mailserver-backup"
EXISTING_NEXTCLOUD_BUCKET="askdaokapra-opensource-mailserver-nextcloud"
