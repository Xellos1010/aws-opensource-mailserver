...
describe('SSM Parameter Resolution Integration', () => {
  ...
  describe('Multi-Domain Support', () => {
    ...
    it('uses default coreParamPrefix for k3frame.com', () => {
      ...
      // Verify stack synthesizes correctly with k3frame.com domain
