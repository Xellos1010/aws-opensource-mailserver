...
### Run All Tests
```bash
pnpm nx test cdk-k3frame-instance
```

### Run Unit Tests Only
```bash
pnpm nx run cdk-k3frame-instance:test:unit
```

### Run Integration Tests Only
```bash
pnpm nx run cdk-k3frame-instance:test:integration
```

### Run E2E Tests (No Deploy Required)
```bash
pnpm nx run cdk-k3frame-instance:test:no-deploy
```

### Run All E2E Tests
```bash
pnpm nx run cdk-k3frame-instance:test:e2e
```
...
### Run with Coverage
```bash
pnpm nx test cdk-k3frame-instance --coverage
```
...
- Ensure instance stack is deployed: `pnpm nx run cdk-k3frame-instance:deploy`
