...
### Run All Tests
```bash
pnpm nx test cdk-k3frame-core
```

### Run Unit Tests Only
```bash
pnpm nx test cdk-k3frame-core --testPathPattern=__tests__
```

### Run Integration Tests Only
```bash
pnpm nx test cdk-k3frame-core --testPathPattern=__it__
```

### Run E2E Tests Only
```bash
pnpm nx test cdk-k3frame-core --testPathPattern=e2e
```

### Run with Coverage
```bash
pnpm nx test cdk-k3frame-core --coverage
```
...
pnpm nx test cdk-k3frame-core --testPathPattern="__tests__|__it__"

# Run only E2E tests
pnpm nx test cdk-k3frame-core --testPathPattern="e2e"

# Run specific test file
pnpm nx test cdk-k3frame-core --testFile=main.spec.ts
```
