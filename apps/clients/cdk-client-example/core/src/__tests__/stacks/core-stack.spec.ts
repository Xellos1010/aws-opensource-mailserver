...
describe('EmcNotaryCoreStack', () => {
  ...
  describe('SSM Parameters', () => {
    it('publishes domain name parameter', () => {
      template.hasResourceProperties('AWS::SSM::Parameter', {
        Name: '/example/core/domainName',
        Description: 'Domain name for sample mailserver mailserver',
      });
    });

    it('publishes backup bucket parameter', () => {
      template.hasResourceProperties('AWS::SSM::Parameter', {
        Name: '/example/core/backupBucket',
        Description: 'S3 backup bucket name',
      });
    });
    ...
    it('publishes nextcloud bucket parameter', () => {
      template.hasResourceProperties('AWS::SSM::Parameter', {
        Name: '/example/core/nextcloudBucket',
    ...
    it('publishes alarms topic parameter', () => {
      template.hasResourceProperties('AWS::SSM::Parameter', {
        Name: '/example/core/alarmsTopicArn',
    ...
    it('publishes SES identity ARN parameter', () => {
      template.hasResourceProperties('AWS::SSM::Parameter', {
        Name: '/example/core/sesIdentityArn',
    ...
    it('publishes EIP allocation ID parameter', () => {
      template.hasResourceProperties('AWS::SSM::Parameter', {
        Name: '/example/core/eipAllocationId',
  ...
  describe('SNS Resources', () => {
    it('creates alarms topic', () => {
      ...
      template.hasResourceProperties('AWS::SNS::Topic', {
        DisplayName: 'sample mailserver Mailserver Alarms',
      });
  ...
  describe('Domain Parameter', () => {
    it('creates domain name parameter with validation', () => {
      ...
      expect(templateJson['Parameters']['DomainName']).toHaveProperty('Default', 'example.com');
