...
describe('Instance Stack Deployment Smoke Tests', () => {
  const cdkOutDir = join(process.cwd(), 'dist/apps/clients/cdk-client-example/instance/cdk.out');
  const testStackName = 'example-com-mailserver-instance';
  ...
  describe('Template Validation', () => {
    beforeAll(() => {
      ...
      try {
        const distDir = join(process.cwd(), 'dist/apps/clients/cdk-client-example/instance');
