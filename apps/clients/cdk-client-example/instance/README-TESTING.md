...
```bash
pnpm nx test cdk-client-example-instance
pnpm nx run cdk-client-example-instance:test:unit
pnpm nx run cdk-client-example-instance:test:integration
pnpm nx run cdk-client-example-instance:test:e2e
pnpm nx run cdk-client-example-instance:test:no-deploy
pnpm nx run cdk-client-example-instance:test:bootstrap
```
...
```bash
pnpm nx test cdk-client-example-observability-maintenance
```

Manual reboot diagnostics:
- `apps/clients/cdk-client-example/observability-maintenance/tests/e2e/README-LAMBDA-TEST.md`
- `apps/clients/cdk-client-example/observability-maintenance/tests/e2e/test-lambda-reboot.sh`
