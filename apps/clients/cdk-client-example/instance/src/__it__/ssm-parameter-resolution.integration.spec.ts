...
describe('SSM Parameter Resolution Integration', () => {
  ...
  describe('Multi-Domain Support', () => {
    ...
    it('uses default coreParamPrefix for example.com', () => {
      const exampleDomainConfig: DomainConfig = {
        domainName: 'example.com',
        instanceDns: 'box',
        coreParamPrefix: '/example/core',
        stackName: 'example-com-mailserver-instance',
      };

      const emcApp = new cdk.App();
      const emcStack = new MailServerInstanceStack(emcApp, 'EmcStack', {
        domainConfig: exampleDomainConfig,
        env: {
          account: '123456789012',
          region: 'us-east-1',
        },
      ...
      // Verify stack synthesizes correctly with example.com domain
