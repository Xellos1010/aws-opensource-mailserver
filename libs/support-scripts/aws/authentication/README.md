...
|----------|-------------|----------|---------|
| `MFA_DEVICE_ARN` | AWS MFA device ARN | No | `arn:aws:iam::<YOUR_ACCOUNT_ID>:mfa/<YOUR_MFA_DEVICE>` |
| `SOURCE_PROFILE` | AWS CLI profile with long-term credentials | No | `your-source-profile` |
| `TARGET_PROFILE` | AWS CLI profile for temporary credentials | No | `your-aws-profile` |
