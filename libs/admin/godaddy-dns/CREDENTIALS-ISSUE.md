...
The test credentials in `data/godaddy/api-keys/sampleuser-account-apikey-test.json` are returning "API Key-Secret is malformed" errors when used with both:
...
3. **If both fail**, regenerate API keys:
   ...
   - Update `data/godaddy/api-keys/sampleuser-account-apikey-test.json`
