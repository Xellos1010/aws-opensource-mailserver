...
- File: `data/godaddy/api-keys/sampleuser-account-apikey-test-2.json`
...
3. **Re-run tests**: 
   ```bash
   source libs/admin/godaddy-dns/bin/load-test-credentials.sh data/godaddy/api-keys/sampleuser-account-apikey-test-2.json
   export GODADDY_TEST_DOMAIN="example.com"  # Use a real domain
