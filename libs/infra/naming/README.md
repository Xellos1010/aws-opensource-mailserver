...
const coreStack = toMailserverCoreStackName('example.com');
// => 'example-com-mailserver-core'

const instanceStack = toMailserverInstanceStackName('example.com');
...
const domain = parseDomainFromMailserverStack('example-com-mailserver-core');
// => 'example.com'

// Generate SSM parameter prefix
const prefix = coreParamPrefix('example.com');
// => '/example/core'

const instancePrefix = instanceParamPrefix('example.com');
// => '/example/instance'
```
...
- CDK apps (`apps/clients/cdk-client-example/core`, `apps/clients/cdk-client-example/instance`)
