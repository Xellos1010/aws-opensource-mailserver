...
interface DomainConfig {
  ...
  coreParamPrefix: string;      // e.g., "/mailexample/core"
  stackName: string;            // e.g., "example-com-mailserver-instance"
}
```
...
const domainConfig: DomainConfig = {
  ...
  instanceDns: 'box',
  coreParamPrefix: '/mailexample/core',
...
- [Instance Stack README](../../../../apps/cdk-client-example-instance/README.md)
