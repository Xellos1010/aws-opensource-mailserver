...
This directory contains deployment and management scripts for the [HEPE Foundation](https://k3frame.com/) mail server infrastructure. Each script is a wrapper that invokes the corresponding script from the `administration/` folder with the domain `k3frame.com`.

## 🌟 About HEPE Foundation

Based on [k3frame.com](https://k3frame.com/), HEPE is a nonprofit charity organization with a 501c3 status, founded by Karina Rodriguez (Dao Kapra) to expand charitable work that has been conducted for nearly two decades. HEPE is a worldwide movement that seeks to recover lost hope, both in ourselves and in humanity.

## 📁 S3 Buckets

This deployment will automatically create S3 buckets with the following naming pattern:
- **Backup Bucket**: `k3frame.com-backup`
- **NextCloud Bucket**: `k3frame.com-nextcloud`
...
### Core Deployment
- **`deploy-stack.sh`** - Deploy the CloudFormation stack for k3frame.com
...
- All scripts automatically use the domain `k3frame.com`
...
- [HEPE Foundation Website](https://k3frame.com/)
