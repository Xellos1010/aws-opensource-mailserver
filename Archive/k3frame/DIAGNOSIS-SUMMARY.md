# Box.k3frame.com Diagnosis Summary

**Date:** December 9, 2025  
**Issue:** box.k3frame.com is not reachable  
...
The instance is running and healthy, but box.k3frame.com is not reachable. This suggests:
...
```bash
# HTTP
curl -v http://box.k3frame.com

# HTTPS
curl -v -k https://box.k3frame.com
...
4. ⏳ Verify box.k3frame.com is reachable after restart
