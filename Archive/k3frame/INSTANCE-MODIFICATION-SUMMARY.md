...
**Requires:** SSH key file (`k3frame.com-keypair.pem`)
...
1. **Ensure SSH key is available:**
   ...
   # - ~/.ssh/k3frame.com-keypair.pem
   # - ~/.ssh/k3frame.com-keypair
   # - ./keys/k3frame.com-keypair.pem
...
```bash
# SSH into instance
ssh -i /path/to/k3frame.com-keypair.pem ubuntu@44.194.23.56
